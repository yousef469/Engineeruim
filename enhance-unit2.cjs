...
const currentUnit2 = fs.readFileSync('src/data/mathematics/unit2-geometry.js', 'utf8');

// Extract lesson 6 (keep it as is)
const lesson6Start = currentUnit2.indexOf('  // LESSON 6:');
const lesson7Start = currentUnit2.indexOf('  // LESSON 7:');
const lesson6Content = currentUnit2.substring(lesson6Start, lesson7Start).trim();

// Enhanced lessons 7-11 content will be added here
...
Imagine you are looking at a city from above:
...
Now imagine you are in a building with floors!
...
// Create the new unit2 file
const newUnit2 = \`// Unit 2: Geometry & Trigonometry (Lessons 6-11) - ENHANCED
// Lessons 7-11 have detailed explanations with visual diagrams
...
fs.writeFileSync('src/data/mathematics/unit2-geometry.js', newUnit2);
console.log('✅ Enhanced lesson 7 added to unit2-geometry.js');
console.log('Note: This script only adds lesson 7. Lessons 8-11 need to be added separately due to size.');
