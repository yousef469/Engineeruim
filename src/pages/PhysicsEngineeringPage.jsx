...
import { ArrowLeft, Atom, Rocket } from 'lucide-react';
...
export default function PhysicsEngineeringPage() {
    ...
    const topics = [
        ...
        },
        {
            ...
            description: 'Pressure, buoyancy, Bernoulli\'s principle, drag',
            lessons: 16,
            color: 'from-cyan-500 to-blue-600'
        },
        {
            title: 'Thermodynamics Fundamentals',
            description: 'Heat, temperature, gas laws, engines',
            lessons: 13,
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
            ...
            <div className="border-b border-gray-700 bg-gray-900/50 backdrop-blur-sm">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-4xl font-bold">Physics for Engineering</h1>
                            <p className="text-gray-400">Essential physics for Rockets, Robotics, Automotive, and Planes</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                {/* Info Box */}
                <div className="mt-12 bg-blue-900/30 border-2 border-blue-500/50 rounded-2xl p-8">
                    <h2 className="text-2xl font-bold mb-4 text-blue-300">Why This Path?</h2>
                    <div className="grid md:grid-cols-2 gap-4 text-gray-200">
                        <div>
                            <p className="mb-2">✓ Engineering-focused physics</p>
                            <p className="mb-2">✓ Practical applications</p>
                            <p>✓ Direct path to mechanics</p>
                        </div>
                        <div>
                            <p className="mb-2">✓ Real-world examples</p>
                            <p className="mb-2">✓ Interactive simulations</p>
                            <p>✓ Build physical intuition</p>
                        </div>
                    </div>
                </div>
            </div>
