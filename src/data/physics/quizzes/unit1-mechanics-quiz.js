export const unit1MechanicsQuiz = {
    1: {
        lessonId: 1,
        questions: [
            {
            ...
            },
            {
                ...
                correctAnswer: 1,
                explanation: 'Displacement is zero because you end up at the same point where you started. Distance traveled equals track length, but displacement is zero.'
            }
        ]
    },
    2: {
        ...
        questions: [
            {
                ...
                correctAnswer: 1,
                explanation: 'Acceleration is the rate at which velocity changes over time. It measures how quickly speed or direction changes.'
            },
            {
                id: 2,
                type: 'multiple-choice',
            ...
            },
            {
                ...
                correctAnswer: true,
                explanation: 'Correct! The slope of a position-time graph represents velocity. Steeper slope = higher velocity = faster motion.'
            },
            {
                id: 4,
                type: 'multiple-choice',
                ...
                correctAnswer: 2,
                explanation: 'The slope of a velocity-time graph represents acceleration - the rate of change of velocity.'
            }
        ]
    },
    3: {
    ...
    4: {
        ...
        questions: [
            ...
            },
            {
                ...
                correctAnswer: false,
                explanation: 'False! Normal force equals weight only on a flat, horizontal surface with no other vertical forces. On inclines or with other forces, they differ.'
            },
            {
                id: 3,
                type: 'multiple-choice',
    ...
    5: {
        ...
        questions: [
            ...
            },
            {
                ...
                correctAnswer: 1,
                explanation: 'Airbags increase the collision time, which reduces the force on passengers (F = Δp/Δt). Same momentum change, longer time = less force.'
            },
            {
                id: 4,
                type: 'multiple-choice',
